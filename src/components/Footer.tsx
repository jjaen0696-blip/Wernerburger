    ...
    <footer className="mt-16 border-t border-white/6 pt-16 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-4">
          <div className="md:col-span-1">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div className="leading-tight">
                <div className="text-sm font-black tracking-[0.25em] text-amber-300 uppercase italic">WERNER</div>
                <div className="text-sm font-semibold tracking-[0.25em] text-white uppercase italic">BURGER</div>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-2"><Mail className="h-4 w-4 shrink-0 text-amber-400" /><span>hola@wernerburguer.com</span></li>
        ...
        <div className="flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-6 md:flex-row">
          <p className="text-xs text-gray-500">© 2025 Werner Burguer. Todos los derechos reservados.</p>
