              ...
              <div className="rounded-[22px] border border-white/10 bg-[#0f0c09]/85 p-4 shadow-[0_25px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
                ...
                <div className="grid gap-4 xl:grid-cols-2">
                  <div className="rounded-[20px] border border-white/10 bg-white/5 p-4">
                    <p className="text-sm text-gray-400">Resumen de stock</p>
                    <div className="mt-4 grid gap-3">
                      <div className="rounded-[18px] border border-white/10 bg-black/40 p-4">
                        <p className="text-xs uppercase tracking-[0.24em] text-amber-300/70">Elementos bajos</p>
                        <p className="mt-2 text-2xl font-black text-white">12</p>
                      </div>
                      <div className="rounded-[18px] border border-white/10 bg-black/40 p-4">
                        <p className="text-xs uppercase tracking-[0.24em] text-amber-300/70">Total de productos</p>
                        <p className="mt-2 text-2xl font-black text-white">68</p>
                      </div>
                    </div>
                  </div>
                  <div className="rounded-[20px] border border-white/10 bg-black/40 p-4">
                    <p className="text-sm uppercase tracking-[0.24em] text-amber-300/70">Actividad reciente</p>
                    <div className="mt-4 space-y-3">
                      {['Stock actualizado en Centro', 'Nuevo ingrediente agregado', 'Entrada de compra registrada'].map((text) => (
                        <div key={text} className="rounded-[16px] border border-white/10 bg-[#0b0b0b]/90 p-3 text-sm text-gray-300">{text}</div>
                      ))}
                    </div>
                  </div>
                </div>
