...
// Correo autorizado para acciones sensibles del panel.
...
export default function Admin({ onBack, onGoKitchen }: Props) {
  ...
  return (
    <div className="min-h-screen bg-premium text-white">
      ...
      <div className="mx-auto flex max-w-[1500px] flex-col gap-6 px-4 py-6 sm:px-6 lg:flex-row lg:items-start">
        {/* Sidebar (desktop) */}
        <aside className="hidden w-64 shrink-0 lg:block">
          <div className="lg:sticky lg:top-[84px] lg:self-start lg:max-h-[calc(100vh-96px)] lg:overflow-y-auto">
            <NavList />
          </div>
        </aside>
